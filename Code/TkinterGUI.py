...
def part3_query1():
    query_conn = sqlite3.connect('LMS.db')
...
def do_query():
	...
	query_conn = sqlite3.connect('LMS.db') # Edit this to be the right database name
...
def create_library_tables():
	...
	conn = sqlite3.connect('LMS.db') # Edit this to be the right database name
